...
| - retry                           | **config.yaml**: `grafana.connection.retry`<br>**flag**: `--grafana.connection.retry` or `-r`<br>**env var**: `GOTS_GRAFANA_CONNECTION_RETRY`      | Configure the connection retry, waiting 2 seconds in between each<br><br>**Type**: `int`<br>**Default**: `0` |
